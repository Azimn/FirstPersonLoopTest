...
class ThresholdMemory:
    ...
    consciously_noticed: dict[str, bool] = field(default_factory=lambda: {
        "hunger": False, "fatigue": False, "pain": False,
        "temperature_discomfort": False, "boredom": False, "interest": False,
    })
...
class ExperienceCompiler:
    ...
    def to_json(self) -> dict[str, object]:
        return {"last_band": self.memory.last_band, "consciously_noticed": self.memory.consciously_noticed}
    ...
    def _render_easing(channel: str, current_band: int) -> str:
        if current_band <= 0:
            return {
                "hunger": "I'm not hungry anymore.", "fatigue": "I don't feel tired anymore.",
                "pain": "The pain is gone.", "temperature_discomfort": "I feel physically comfortable again.",
                "boredom": "I'm not bored anymore.", "interest": "That fascination has finally loosened its grip on me.",
            }[channel]
        return {
            "hunger": "My hunger is easing.", "fatigue": "I feel a little less tired now.",
            "pain": "The pain is easing.", "temperature_discomfort": "I'm starting to feel more physically comfortable.",
            "boredom": "I'm not nearly as bored now.", "interest": "My fascination with this is beginning to loosen its grip on my attention.",
        }[channel]
